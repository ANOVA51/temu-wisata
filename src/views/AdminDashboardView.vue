...
// Data
const selectedWisata = ref({}) // <-- Tambahkan baris ini!
...
// function viewWisataDetail(wisata) {
//   selectedWisata.value = wisata
//   // Jika ada field images, tampilkan semua gambar
...
// Approve: update is_verified ke true
// const approvePendingWisata = async (wisata) => {
//   try {
//     await fetch(`http://localhost:8000/api/touristspots/${wisata.id}/update/`, {
//       method: 'PATCH',
//       headers: {
//         'Content-Type': 'application/json',
//         // Tambahkan Authorization jika perlu
...
//       body: JSON.stringify({ is_verified: true })
//     })
//     // Hapus dari pending, refresh list
//     pendingWisata.value = pendingWisata.value.filter(w => w.id !== wisata.id)
//     // Optional: refresh wisataList jika ingin langsung muncul di Wisata Manage
//   } catch (e) {
//     alert('Gagal approve wisata')
//   }
// }

// Reject: hapus spot wisata
// const rejectPendingWisata = async (wisata) => {
//   try {
//     await fetch(`http://localhost:8000/api/touristspots/${wisata.id}/delete/`, {
//       method: 'DELETE'
//     })
//     pendingWisata.value = pendingWisata.value.filter(w => w.id !== wisata.id)
//   } catch (e) {
  ...
  <div class="flex h-screen bg-gray-100">
    ...
    <main class="flex-1 p-10 relative overflow-hidden bg-white rounded-tr-3xl rounded-br-3xl">
      ...
      <div v-else-if="active === 'confirm-wisata'">
        ...
        <!-- Tambahkan max-h-screen dan overflow-y-auto agar bisa discroll -->
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6 max-h-screen overflow-y-auto pr-2">
          <div
    ...
    <transition name="popup-fade">
      ...
      >
        ...
        <!-- Popup: lebih lebar -->
        <div
          class="relative bg-white rounded-xl p-8 max-w-5xl w-full mx-4 shadow-2xl animate-popup"
          @click.stop
        >
          <div class="flex justify-between items-center mb-6">
          ...
          <div class="bg-white rounded-lg p-0">
            <!-- Tambahkan gap-12 dan padding kanan pada gambar, padding kiri pada detail -->
            <div class="flex flex-col lg:flex-row gap-12">
              <div class="pr-8 flex-shrink-0 flex justify-center">
                <!-- Carousel gambar: klik gambar untuk next, tampilkan semua gambar -->
                <div
                ...
                <div
                  v-else
                  class="h-[320px] w-[320px] bg-gradient-to-br from-blue-400 to-blue-600 rounded-lg flex items-center justify-center mb-4"
                >
